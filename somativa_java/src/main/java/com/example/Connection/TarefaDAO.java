...
public class TarefaDAO {
    ...
    public void adicionarTarefa(String titulo, String descricao, LocalDate dataVendimento, String prioridade,
            String status) {

        String query = "INSERT INTO tarefa (titulo, decricao, data_vencimento, prioridade, status)" +
                "VALUES (?,?,?,?,?)";
    ...
    public void concluirTarefa(String buscarTarefa) {
        String query = "UPDATE tarefa SET status = 'Concluido' WHERE titulo = ?";
